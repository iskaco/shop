    ...
    <div>
        ...
        <div class="relative z-20 bg-white dark:bg-form-input">
            ...
            >
                ...
                <option value="USA" class="text-body dark:text-bodydark">
                    USA
                </option>
                <option value="UK" class="text-body dark:text-bodydark">
                    UK
                </option>
                <option value="Canada" class="text-body dark:text-bodydark">
                    Canada
                </option>
            </select>
