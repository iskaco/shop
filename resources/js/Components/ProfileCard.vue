...
export default {
    methods: {
        getImage() {
            return this.route("admin.table.getMedia", [
                "App\\Models\\Admin",
                this.$page.props.auth.admin.id,
                "profile_image",
                false,
            ]);
        },
    ...
    >
        ...
        <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div class="mt-4">
                ...
                >
                    {{
                        $page.props.auth.admin.first_name +
                        " " +
                        $page.props.auth.admin.last_name
                    }}
                </h3>
                <p class="font-medium">
                ...
                <div class="mx-auto max-w-180">
                    ...
                    <p class="mt-4.5 text-sm font-normal">
                        من یک مدیر سیستم با تجربه در زمینه مدیریت سرور و شبکه
                        هستم. تخصص اصلی من در نگهداری و بهینه‌سازی سیستم‌های تحت
                        وب و پایگاه‌های داده است. همواره تلاش می‌کنم با
                        به‌روزرسانی دانش فنی خود، بهترین راهکارها را برای حل
                        مشکلات ارائه دهم. امنیت و کارایی سیستم برای من در اولویت
                        قرار دارد.
                    </p>
                </div>
